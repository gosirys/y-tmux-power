...
LS="#[fg=$TC,bg=$G07,bold] $user@#h #[fg=$TC,bg=$G06,nobold]${right_arrow_icon}"
...
RS="#[fg=$TC,bg=$G06] $time_icon $time_format #[fg=$G05,bg=$G06]$left_arrow_icon#[fg=$TC,bg=$G05] $date_icon $date_format "
if "$show_download_speed"; then
    RS="#[fg=$G05,bg=$BG]$left_arrow_icon#[fg=$TC,bg=$G05] $download_speed_icon #{download_speed} #[fg=$G05,bg=$G06]$left_arrow_icon$RS"
fi
if "$show_upload_speed"; then
    RS="#[fg=$G05,bg=$BG]$left_arrow_icon#[fg=$TC,bg=$G05] $upload_speed_icon #{upload_speed} #[fg=$G06,bg=$G06]$left_arrow_icon$RS"
# else
